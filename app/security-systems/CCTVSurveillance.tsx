...
import CCTVSurveillanceImage1 from "@/assets/images/manFixingCamera.png"

function CCTVSurveillance() {
  return (
    <>
      <p>
        In today’s world, securing your assets requires more than just physical locks, it demands continuous, intelligent visibility. 
        We engineer and deploy professional-grade CCTV surveillance systems tailored to protect homes, businesses, and industrial facilities across Ghana.
      </p>
      <br />
      <p>
        Whether you need to monitor remote perimeters, secure high-traffic retail spaces, or establish secure corporate surveillance networks, 
        our end-to-end solutions keep you connected to what matters most, 24/7
      </p>
      <button
       className="bg-white rounded-full px-6 py-3 my-6 hover:bg-gray-200 hover:scale-97 active:scale-102 transition-all cursor-pointer duration-300"
        onClick={() => {}}
      >
        Request Quote &#10132;
      </button>
      ...
      <ol className="capitalize">
        <li>
          ...
          <p className="mb-5">
            Walk through the property with the client to map out clear vulnerabilities. 
            We identify high-risk areas—such as entry/exit perimeters, dark zones, and
            cash-handling points—and establish the target Field of View (FOV) for every
            intended camera drop.
          </p>
        </li>
        <li>
          <p className="font-semibold">
            2. System Engineering & Design Approval:
          </p>
          <p className="subtitle">
            Phase 2: Architecture
          </p>
            <p className="mb-5">
            We build a complete schematic layout of the network topology. This includes selecting
            the ideal hardware combination (Domes indoors, Bullets outdoors, Smart Sensors for 
            entryways) and calculating power consumption constraints to size the PoE switches 
            and UPS backups perfectly.
          </p>
        </li>
        <li>
          <p className="font-semibold">
            3. Civil Works, Cable Containment & Infrastructure:
          </p>
          <p className="subtitle">
            Phase 3: Deployment
          </p>
          <p className="mb-5">
            The actual physical layout begins. Our technicians run solid copper Cat6 cabling entirely 
            enclosed within heavy-duty, weatherproof PVC conduits or galvanized metal trunking. 
            This guarantees absolute protection against both rough weather elements and intentional 
            manual tampering.
          </p>
        </li>
        <li>
          <p className="font-semibold">
            Machine Room Setup & System Tuning:
          </p>
          <p className="subtitle">
            Phase 4: Optimization
          </p>
          <p className="mb-5">
            We mount the core equipment inside a secure, lockable network rack. Hard drives are initialized,
            cameras are fine-tuned for crisp day/night visibility, and compression protocols like H.265+ 
            are activated to maximize recording storage days without losing image quality.
          </p>
        </li>
        <li>
          <p className="font-semibold">
            5. remote Gateway Syncing & Client Sign-Off:
          </p>
          <p className="subtitle">
            Phase 5: Handover
          </p>
          <p className="mb-5">
            We establish an encrypted P2P cloud connection so you can view crystal-clear video streams 
            on your phone from anywhere. We train your team on how to retrieve footage, review safety 
            sensor alerts, and complete the official project handover with documentation.
          </p>
        </li>
      </ol>
    </>
