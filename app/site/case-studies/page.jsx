    ...
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="section-shell space-y-32">
        ...
        <div className="max-w-4xl space-y-6">
          <span className="pill border-blue-600/20 text-blue-600 bg-blue-50 uppercase tracking-[0.2em] text-[10px] font-bold">Proven Architectures</span>
        ...
        <div className="space-y-40">
          {projects.length > 0 ? (
            projects.map((study, idx) => (
              <div key={study._id || idx} className={`flex flex-col lg:flex-row gap-16 items-center ${idx % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                {/* Visual Spotlight */}
        ...
        <div className="rounded-[4rem] bg-slate-950 p-16 md:p-24 text-center space-y-10 relative overflow-hidden">
           ...
           <div className="relative z-10">
              <Link href="/site/contact" className="inline-flex items-center gap-3 px-12 py-6 bg-blue-600 text-white rounded-full font-extrabold text-lg hover:bg-white hover:text-slate-950 transition-all shadow-2xl shadow-blue-600/20">
