    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-white text-slate-900 pt-32 pb-24 px-4 border-b border-slate-100">
        ...
        <div className="section-shell relative space-y-10">
          <span className="pill border-blue-600/20 text-blue-600 bg-blue-50 uppercase tracking-[0.2em] text-[10px] font-black">Investment Guide</span>
          ...
          <div className="flex overflow-x-auto no-scrollbar gap-2 py-4">
            {categories.map((cat) => (
              <button
                ...
                className={`whitespace-nowrap px-6 py-3 rounded-full text-sm font-black uppercase tracking-widest transition-all ${activeCategory === cat.id
              ...
              >
                ...
                <div className="space-y-2 mb-8">
                  ...
                  <div className="pt-4 flex flex-col">
                    ...
                    {pkg.renewal && (
                      <div className={`mt-2 text-[9px] font-black uppercase tracking-wider py-1.5 px-3 rounded-lg w-fit ${pkg.featured ? "bg-white/10 text-blue-300" : "bg-slate-50 text-slate-500 border border-slate-100"}`}>
                ...
                <div className="mt-8">
                  <Link
                    href="/site/contact"
                    className={`w-full inline-flex justify-center items-center px-6 py-4 rounded-xl font-black text-xs transition-all ${pkg.featured
