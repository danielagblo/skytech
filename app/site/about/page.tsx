  ...
  return (
    <div className="text-xl">
      ...
      <div className="grid grid-cols-1 px-6 gap-5 items-center justify-center text-center md:grid-cols-[2fr_1fr] md:pl-12 md:pr-[3.75rem] md:px-0 md:text-left">
        <div>
          <h1 className="text-3xl uppercase max-md:mt-[1.875rem] mb-3 md:text-5xl">
      ...
      <div className="grid grid-cols-1 bg-[#f1f1f1] px-6 gap-5 items-center justify-center text-center md:grid-cols-[1fr_2fr] md:pl-7 md:pr-[3.75rem] md:px-0 md:text-left">
        <div className="p-6 md:p-10">
          <Image
      ...
      <div className="bg-[#f1f1f1] p-6 mt-8 md:p-10 md:mt-12">
        ...
        <p>
          ...
          <br /><br />
          Skytech Ghana moved away from simply selling &quot;one-size-fits-all&quot; software packages. They pivoted to become a comprehensive digital transformation and spatial partner. They recognized that true digital evolution requires walking alongside a client&mdash;handling everything from raw data analysis and spatial information management to building the actual applications that streamline everyday business operations.
        </p>
      </div>

      <div className="grid grid-cols-1 px-6 gap-5 items-center justify-center text-center md:grid-cols-[1fr_2fr] md:pl-7 md:pr-[4.25rem] md:px-0 md:text-left">
        <div className="p-6 md:p-10">
          <Image
