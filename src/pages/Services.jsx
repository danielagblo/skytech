...
export default function Services() {
  ...
  return (
    <>
      <Helmet>
        <title>Services - SkyTech Software Solutions</title>
        <meta name="description" content="Explore SkyTech's comprehensive software development services including web development, mobile apps, and cloud solutions." />
        <meta property="og:title" content="Services - SkyTech Software Solutions" />
        <meta property="og:description" content="Explore SkyTech's comprehensive software development services." />
      </Helmet>
      ...
      <section className="relative overflow-hidden py-16 bg-gradient-to-r from-blue-700 to-blue-500 text-white">
        ...
        <div className="section-shell relative text-center space-y-6">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <a href="/contact" className="btn-primary bg-white text-blue-700 hover:bg-blue-50 shadow-white/30">Schedule a consultation</a>
            <a href="/contact" className="btn-secondary border-white/60 text-white hover:bg-white/10">Share your brief</a>
          </div>
        </div>
      </section>
    </>
