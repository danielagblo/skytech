        ...
        <div className="mx-auto grid max-w-[80rem] gap-12 md:grid-cols-[1.2fr_1fr_1fr_1.4fr]">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                onClick={() => openWhatsApp(whatsappLink.replace(/\D/g, ""))}
                aria-label="WhatsApp"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 text-slate-300 ring-1 ring-white/10 transition hover:bg-slate-900 hover:text-white cursor-pointer"
              >
