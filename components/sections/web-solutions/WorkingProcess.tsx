...
export default function WorkingProcess() {
  return (
    <section className="py-20 px-10">
      <h2 className="text-5xl text-center font-normal leading-tight mb-24 max-w-3xl mx-auto">
        Our working process on how to grow your business
      </h2>

      <div className="relative">
        <div className="absolute top-2/7 left-0 right-0 border-t-3 border-dashed border-gray-300 z-0" />

        <div className="grid grid-cols-3 gap-8 px-17.5 relative z-10">
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col">
              <div className="w-60 h-60 rounded-full overflow-hidden mx-auto mb-8 bg-black shrink-0">
                <Image
                  src={step.image}
                  alt={step.alt}
