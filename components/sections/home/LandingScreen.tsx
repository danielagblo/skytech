...
function LandingScreen() {
  ...
  return (
    <div>
      ...
      />
      <div className='uppercase flex flex-col items-center justify-center gap-10 px-6 pt-5 pb-10 text-center text-white md:h-[65vh] md:flex-row md:items-end md:justify-center md:gap-0 md:px-10 md:pt-0 md:pb-0 md:mb-6 md:text-left'>
        <div
          className='w-full md:w-[75vw]'
        >
          <div>
            <h1 className='max-md:[-webkit-text-stroke:2px_black] font-black md:font-bold text-5xl md:text-8xl'>
              8 + years <br />
              in operation
            </h1>
          </div>
          <div
            className='flex flex-col items-center gap-5 md:w-[25vw] md:items-end md:justify-end md:hidden'
            >
              <div className='flex flex-row justify-center items-end'>
                <Image
                  src={homeAward2}
                  alt="Award 2"
                  className='h-14 object-contain md:-mb-4 md:h-18 -mr-15 max-md:ml-15'
                />
                <Image
                  src={homeAward}
                  alt="Award"
        ...
        <div
          className='flex flex-col items-center gap-5 md:w-[25vw] md:items-end md:justify-end max-md:hidden'
        >
          <div className='flex flex-row justify-center items-end'>
            <Image
              src={homeAward2}
