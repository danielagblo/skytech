    ...
    <html lang="en">
      ...
      <body>
        <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-blue-50">
          {/* Sidebar */}
          <aside className="w-72 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white p-6 shadow-2xl border-r border-slate-700">
            <div className="mb-10">
            ...
            <div className="mt-auto pt-6 border-t border-slate-700">
              <button className="w-full px-4 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-xl text-sm font-semibold transition-all duration-200 shadow-lg hover:shadow-xl">
                🚪 Logout
              </button>
            </div>
          </aside>
